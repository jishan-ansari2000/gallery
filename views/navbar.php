...
<div class="modal fade" id="signupModalToggle" aria-labelledby="signupModalToggleLabel" tabindex="-1"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="controllers/auth.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="signup_email" aria-describedby="emailHelp" name="signup_email">
          </div>
          <div class="mb-3">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" data-bs-target="#loginModalToggle" data-bs-toggle="modal">Back to Login</button>
      </div>
    </div>
  </div>
</div>
